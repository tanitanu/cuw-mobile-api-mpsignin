...
{
    public class QAOnPremService : IQAOnPremService
    {
        private readonly ICacheLog<QAOnPremService> _logger;
        private readonly IResilientClient _resilientClient;

        public QAOnPremService(ICacheLog<QAOnPremService> logger, [KeyFilter("OnPremSQLQAClientKey")] IResilientClient resilientClient)
        {
            _logger = logger;
