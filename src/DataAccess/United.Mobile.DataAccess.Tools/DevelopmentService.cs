...
namespace United.Mobile.DataAccess.Tools
{
    ...
    {
        private readonly ICacheLog<DevelopmentService> _logger;
        private readonly IResilientClient _resilientClient;

        public DevelopmentService(
              [KeyFilter("DevelopmentClientKey")] IResilientClient resilientClient
            , ICacheLog<DevelopmentService> logger)
        {
