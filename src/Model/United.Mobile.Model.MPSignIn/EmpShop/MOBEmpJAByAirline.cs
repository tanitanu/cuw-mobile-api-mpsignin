...
namespace United.Mobile.Model.Common
{
    ...
    public class MOBEmpJAByAirline
    {
        ...
        public bool CanBookFirstOnBusiness { get; set; } = false;

        public bool CanBookSpouseOnBusiness { get; set; } = false;
        ...
        public bool FeeWaivedFirst { get; set; } = false;

        public bool FeeWaivedCoach { get; set; } = false;
