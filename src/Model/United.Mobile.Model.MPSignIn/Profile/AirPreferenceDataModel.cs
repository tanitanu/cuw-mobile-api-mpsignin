...
namespace United.Definition.CSLModels.CustomerProfile
{
    public class AirPreferenceDataModel
    {
        ...
        public string AirportNameLong { get; set; }

        public string MealCode { get; set; }

        public string MealDescription { get; set; }

        public string SeatSideDescription { get; set; }
        ...
        public string SearchPreferenceDescription { get; set; }

        public int NumberOfFlightsDisplay { get; set; }
