...
namespace United.Utility.Http
{
    public interface IResilientClient
    {
        ...
        Task<(string response, HttpStatusCode statusCode, string url)> PutAsync(string endPoint, string requestData, IDictionary<string, string> requestHeaders = null, string contentType = "application/json", bool throwWebException = true);
