...
namespace United.Utility.Serilog
{
    public class TimedOperation : IDisposable
    {
        ...
        public TimedOperation(ICacheLog<TimedOperation> logger)
        {
            _logger = logger;
        }
        ...
        public TimedOperation(ICacheLog logger, LogLevel level, TimeSpan? warnIfExceeds, object identifier, string description,
