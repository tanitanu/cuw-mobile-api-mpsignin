...
namespace United.Mobile.MPAuthentication.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                services.AddScoped<IMPAuthenticationBusiness, MPAuthenticationBusiness>();
                ...
                services.AddScoped<IUCBProfile, UCBProfile>();
                ...
                services.AddScoped<IHashedPin, HashedPin>();
        ...
        public void ConfigureContainer(ContainerBuilder container)
        {
            try
            {
                ...
                container.Register(c => new ResilientClient(Configuration.GetSection("EmployeeTravelTypeServiceClient").Get<ResilientClientOpitons>())).Keyed<IResilientClient>("EmployeeTravelTypeServiceClientKey");
                container.RegisterType<EmployeeTravelTypeService>().As<IEmployeeTravelTypeService>().WithAttributeFiltering();
                ...
                container.Register(c => new ResilientClient(Configuration.GetSection("homePageContentClient").Get<ResilientClientOpitons>())).Keyed<IResilientClient>("homePageContentClientKey");
                container.RegisterType<HomePageContentService>().As<IHomePageContentService>().WithAttributeFiltering();
                ...
                container.Register(c => new ResilientClient(Configuration.GetSection("CorporateDataClient").Get<ResilientClientOpitons>())).Keyed<IResilientClient>("CorporateDataClientKey");
                container.RegisterType<CorporateGetService>().As<ICorporateGetService>().WithAttributeFiltering();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IApplicationEnricher applicationEnricher, IFeatureSettings featureSettings, IHostApplicationLifetime applicationLifetime)
        {
            try
            {
                ...
                app.MapWhen(context => string.IsNullOrEmpty(context.Request.Path) || string.Equals("/", context.Request.Path), appBuilder =>
                {
                    ...
                    {
                        await context.Response.WriteAsync("Welcome from Mileage Plus Authentication Microservice").ConfigureAwait(false);
                    });
                });
        ...
        private async Task OnStart(IFeatureSettings featureSettings)
        {
            try
            {
                await featureSettings.LoadFeatureSettings(United.Mobile.Model.Common.ServiceNames.MPAUTHENTICATION.ToString());
            }
            catch (Exception) { }
        ...
        private async Task OnShutDown(IFeatureSettings featureSettings)
        {
            try
            {
                await featureSettings.DeleteContainerIPAdress(United.Mobile.Model.Common.ServiceNames.MPAUTHENTICATION.ToString(), StaticDataLoader._ipAddress);
            }
            catch { }
        }
    }
